export const STAFF_COPY = {
  ...
  invitation: {
    ...
    accept: {
      ...
      description:
        'Completá el formulario para crear tu cuenta. Usá la palabra de seguridad que acordaste con tu administrador, si corresponde.',
  ...
  invitationsTable: {
    ...
    loadError: 'No pudimos cargar las invitaciones. Intentá de nuevo.',
    retry: 'Reintentar',
