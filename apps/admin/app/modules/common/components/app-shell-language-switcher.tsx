        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <ChevronUp
                aria-hidden="true"
                className="ml-auto size-4 shrink-0 opacity-60 transition-transform duration-(--duration-fast) ease-emphasized group-data-[state=open]/lang-trigger:rotate-180 motion-reduce:transition-none"
              />
            </SidebarMenuButton>
          </DropdownMenuTrigger>
          <DropdownMenuContent
