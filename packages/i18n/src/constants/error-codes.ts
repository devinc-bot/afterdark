export const AUTH_ERROR_CODE = {
  ...
  USER_REGISTRATION_RATE_LIMITED: 'auth.USER_REGISTRATION_RATE_LIMITED',
  ROLE_NOT_CONFIGURED: 'auth.ROLE_NOT_CONFIGURED',
  REGISTER_SUCCESS: 'auth.REGISTER_SUCCESS',
  OWNER_PENDING_APPROVAL: 'auth.OWNER_PENDING_APPROVAL',
} as const
