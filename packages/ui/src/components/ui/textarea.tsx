...
const textareaVariants = cva(
  'cn-gradient-border flex min-h-[120px] w-full resize-y rounded-app px-4 py-3 text-base text-ink placeholder:text-ink-muted-soft transition-[box-shadow] focus-visible:outline-none focus-visible:ring-2 aria-invalid:focus-visible:ring-error/40 disabled:cursor-not-allowed disabled:resize-none motion-reduce:transition-none',
  {
    variants: {
      variant: {
        default:
