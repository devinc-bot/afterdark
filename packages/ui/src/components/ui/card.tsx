...
const cardVariants = cva(
  'rounded-app-lg text-ink transition-shadow hover:shadow-[0_4px_16px_rgba(0,0,0,0.04)]',
  {
    variants: {
      variant: {
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn('text-[16px] leading-normal tracking-[0.16px] text-ink-muted', className)}
    {...props}
  />
))
