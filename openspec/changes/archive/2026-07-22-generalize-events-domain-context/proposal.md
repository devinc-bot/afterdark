...
- Soften brand personality copy that locks the product to nightclub energy, while keeping the dark, restrained visual direction where it still fits a general events brand named afterdark.
...
- No rename of the product/brand “afterdark”.
...
- `product-context`: Canonical product/domain framing for agents and humans — what afterdark is, who it serves, and core entities — expressed as general events (not nightlife-only), with locations instead of clubs in active docs.
