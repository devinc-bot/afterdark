# Progreso de entrevista — `010-location-create-edit-page`

> **Rename (2026-07-17):** ex `010-club-create-edit-page`. Ajustes de copy/rutas/`type` se coordinan con `002-locations-management`.
